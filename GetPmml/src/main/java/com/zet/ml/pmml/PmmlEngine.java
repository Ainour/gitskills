...
public class PmmlEngine {
     ...
     */
    public static PMML createPmmlDataHolder(InputStream is) {
     ...
     * @return result map
     */
    public static Map evaluate(PmmlLoadParam pmmlLoadParam,
        ...
        Evaluator evaluator = curHolder.getEvaluator();
